  ...
  it(
    ...
    async () => {
      ...
      try {
        ...
        expect(getComputedStyle(page).backgroundColor).toBe("rgb(13, 11, 16)");
  ...
  it(
    ...
    async () => {
      ...
      try {
        ...
        // (#0d0b10 → 13,11,16) — the {alpha:false} canvas's one-fillRect
        ...
        expect([px[0], px[1], px[2]]).toEqual([13, 11, 16]);
